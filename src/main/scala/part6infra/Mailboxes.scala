...
/**
 * Mailboxes are datastructures that store messages which are then consumed by actors
 */
object Mailboxes extends App {
  ...
  // step 2 - make it known in your application.conf
  ...
  // supportTicketLogger ! PoisonPill    // it gets processed P0, P1 and P3... it could be a problem.
  supportTicketLogger ! "[P3] this thing will be nice to have"
  ...
  controlAwareActor ! "[P3] this thing will be nice to have"
  ...
  altControlAwareActor ! "[P3] this thing will be nice to have"
